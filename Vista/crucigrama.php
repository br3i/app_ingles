    ...
    <div class="col-md-12">
      ...
      <table class="table">
        <tr>
          <td>
            Horizontales<br />
            - <img src="../Publico/img/crucigrama/palabra1.png" width="50" /><button id="btn" onclick="reproducirAudio(1)">Audio</button><br />
            - <img src="../Publico/img/crucigrama/palabra2.png" width="50" /><button id="btn" onclick="reproducirAudio(2)">Audio</button><br />
          </td>
          <td>
            Verticales<br />
            - <img src="../Publico/img/crucigrama/palabra3.png" width="50" /><button  id="btn" onclick="reproducirAudio(3)">Audio</button><br />
            - <img src="../Publico/img/crucigrama/palabra4.png" width="50" /><button id="btn" onclick="reproducirAudio(4)">Audio</button><br />
          </td>
        </tr>
      </table>
      <table class="table">
