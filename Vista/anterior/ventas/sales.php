		...
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
			<div class="container mt-5 p-5">
				...
				<div class="row text-center" style="background-color: #2b7b32">
					<div class="col-md-7"> 
						<strong style="color: white">Buscar Cliente para realizar la venta</strong>
					</div>	
				</div>
										...
										<div class="container mt-1">
											<div class="col-6">
												...
												<div class="mdl-textfield__expandable-holder">
													<div class="mb-2">
														<input onkeyup="buscar_ahora($('#searchClient').val());" type="text" class="mdl-textfield__input" id="searchClient" name="searchClient" placeholder="cédula">
											...
											<div  class="mb-8">
												<div class="card-body">
													<div id="buscador" class="container pl-1 pr-1"></div>
												</div>
											</div>
										</div>
									</div>
