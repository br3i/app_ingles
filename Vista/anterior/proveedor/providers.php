	...
	<section class="full-width pageContent">
		...
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
			<div class="container mt-5 p-5">
				...
				$sqlProveedor   = ("SELECT * FROM proveedores ORDER BY ID_PRO DESC ");
				$queryProveedor = mysqli_query($conexion, $sqlProveedor);
				$cantidadP= mysqli_num_rows($queryProveedor);
				?>
				<div class="row text-center" style="background-color: #2b7b32">
					<div class="col-md-6"> 
						<strong style="color: white">Registrar Nuevo Proveedor</strong>
					</div>
					<div class="col-md-6"> 
						<strong style="color: white">Lista de Proveedores <span style="color: white">  ( <?php echo $cantidadP; ?> )</span> </strong>
					</div>
				</div>
						...
						<div class="body">
							<div class="row clearfix">
								<div class="col-sm-5">
									...
									<?php include('registrarProveedor.php');  ?>
								</div>  
									...
									<div class="row">
										<div class="col-md-20 p-2">
											<form class="table-responsive">
													...
													<div class="col-40">
														<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
															...
															<div class="mdl-textfield__expandable-holder">
																<div class="mb-3">
																	<input onkeyup="buscar_P($('#searchProveedor').val());" type="text" class="mdl-textfield__input" id="searchProveedor" name="searchProveedor">
														...
														<div class="card col-35 mt-0">
																<div class="card-body">
																	<div id="buscadorP" class="container pl-0 pr-0"></div>
																</div>
														</div>
													</div>
												</div>
												...
												<script type="text/javascript">
													function buscar_P(buscarP) {
													var parametros = {"buscarP":buscarP};
													var a=document.getElementById("searchProveedor").value;
													if(a!=""){
														$.ajax({
														data:parametros,
														type: 'POST',
														url: 'buscadorProveedor.php',
														success: function(data) {
															document.getElementById("buscadorP").innerHTML = data;
														}
														});
														}}
												</script>
										...
										<div class="table-responsive">
											<table class="table table-bordered table-striped table-hover">
												...
												<?php include("../../Modelo/proveedor/consultar.php");?>
											</table>
										</div>
								</div>
							</div>
			...
			<script type="text/javascript">
				...
				$('.btnBorrar').click(function(e){
					e.preventDefault();
					var id = $(this).attr("idPV");
					var dataString = 'idPV='+ id;
					url = "../../Modelo/proveedor/eliminar.php";
					$.ajax({
					type: "POST",
					url: url,
					data: dataString,
