	...
	<section class="full-width navLateral">
		...
		<div class="full-width navLateral-body">
			<div class="full-width navLateral-body-logo text-center tittles">
				<i class="zmdi zmdi-close btn-menu"></i> VIVERO "EL TREBOL" 
			</div>
	...
	<section class="full-width pageContent">
		...
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
			<div class="container mt-5 p-5">
				...
				$sqlCategoria   = ("SELECT * FROM categoria ORDER BY ID_CATE DESC ");
				$queryCategoria = mysqli_query($conexion, $sqlCategoria);
				$cantidadP= mysqli_num_rows($queryCategoria);
				?>
				<hr>
				<div class="row text-center" style="background-color: #2b7b32">
					<div class="col-md-6"> 
						<strong style="color: white">Registrar Nueva Categoría</strong>
					</div>
					<div class="col-md-6"> 
						<strong style="color: white">Lista de Categoría <span style="color: white">  ( <?php echo $cantidadP; ?> )</span> </strong>
					</div>
				</div>

				<div class="row clearfix">
					<div class="col-lg-10 col-md-4 col-sm-4 col-xs-10">
						<div class="body">
							<div class="row clearfix">
								<div class="col-sm-5">
								...
								<div class="col-sm-6" >
									<div class="row">
										<div class="col-md-0 p-7">
											<form class="table-responsive">
												<?php include("../../Config/conexion.php"); ?>
												<div class="container mt-7">
													<div class="col-50">
														<div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable">
															<label class="mdl-button mdl-js-button mdl-button--icon" for="searchCategoria">
																<i class="zmdi zmdi-search"></i>
															</label>
															<div class="mdl-textfield__expandable-holder">
																<div class="mb-0">
																	<input onkeyup="buscar_Cate($('#searchCategoria').val());" type="text" class="mdl-textfield__input" id="searchCategoria" name="searchCategoria">
														...
														<div class="card col-35 mt-0">
																<div class="card-body">
																	<div id="buscadorCate" class="container pl-0 pr-0"></div>
																</div>
														</div>
													</div>
												</div>
												...
												<script type="text/javascript">
													function buscar_Cate(buscarCate) {
													var parametros = {"buscarCate":buscarCate};
													var a=document.getElementById("searchCategoria").value;
													if(a!=""){
														$.ajax({
														data:parametros,
														type: 'POST',
														url: 'buscadorCate.php',
														success: function(data) {
															document.getElementById("buscadorCate").innerHTML = data;
														}
														});
														}}
												</script>
										...
										<div class="table-responsive">
											<table class="table table-bordered table-striped table-hover">
												...
												<?php include("../../Modelo/categoria/consultar.php");?>
											</table>
										</div>
								</div>
							</div>
			...
			<script type="text/javascript">
				...
				$('.btnBorrar').click(function(e){
					...
					url = "../../Modelo/categoria/eliminar.php";
					$.ajax({
					type: "POST",
					url: url,
					data: dataString,
