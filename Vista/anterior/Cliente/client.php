	...
	<section class="full-width pageContent">
		...
		<div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
			<div class="container mt-5 p-5">
				...
				$sqlCliente   = ("SELECT * FROM cliente ORDER BY ID_CLI DESC ");
				$queryCliente = mysqli_query($conexion, $sqlCliente);
				$cantidad     = mysqli_num_rows($queryCliente);
				?>				
				<div class="row text-center" style="background-color: #2b7b32">
					<div class="col-md-6"> 
						<strong style="color: white">Registrar Nuevo Cliente</strong>
					</div>
					<div class="col-md-6"> 
						<strong style="color: white">Lista de Clientes <span style="color: white">  ( <?php echo $cantidad; ?> )</span> </strong>
					</div>
				</div>
									...
									<div class="row">
										...
										<div class="table-responsive">
											<table class="table table-bordered table-striped table-hover">
												...
												<?php include("../../Modelo/cliente/consultar.php");?>
											</table>
										</div>
								</div>
							</div>
			...
			<script type="text/javascript">
				...
				$('.btnBorrar').click(function(e){
					...
					url = "../../Modelo/Cliente/eliminar.php";
					$.ajax({
					type: "POST",
					url: url,
					data: dataString,
